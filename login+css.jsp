                        	...
                        	<div class="form-box" style='margin-bottom: 10%;'>
	                        	<div class="form-top">
	                        		<div class="form-top-left">
	                        			<h1>Login</h1>
	                            		<p>Enter username,password and user type to log on:</p>
	                        		</div>
	                            ...
	                            <div class="form-bottom" style="color:white;">
				                    <form role="form" action="j_security_check" method="post" class="login-form">
                                        ...
                                        <div class="form-group">
				                        	...
				                        	<input required type="usertype" name="j_usertype" placeholder="usertyped..." class="form-usertype form-control" id="form-usertype">
				                        </div>
